                        ...
                        <form id="studentForm">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="row">
                                        ...
                                        <div class="col">
                                            <div class="mb-3">
                                                <label for="perjalanan_ke_sekolah" class="form-label required">Perjalanan
                                                    ke sekolah</label>
                                    ...
                                    <div class="mb-3">
                                        <label for="imunisasi" class="form-label required">Imunisasi yang telah
                                            diikuti</label>
                                        <select class="form-control" id="imunisasi" name="imunisasi[]" multiple required>
                            ...
                            <div class="row mb-3">
                                <div class="col">
                                    ...
                                    <div class="mb-3">
                                        <label for="penghasilan_per_bulan_ayah" class="form-label required">Penghasilan
                                            per bulan (IDR)</label>
                                    ...
                                    <div class="mb-3">
                                        <label for="scan_ktp_ayah" class="form-label required">Foto KTP Ayah (Lurus dan
                                            jelas)</label>
