...
@section('content')
    <div class="content-body default-height">
        <div class="container-fluid">
            <div class="form-head mb-4">
                <h2 class="text-black font-w600 mb-0">PPDB - Setting</h2>
            </div>
            <!-- coba -->
            <div class="row">
                <div class="card">
                    <div class="card-header d-sm-flex d-block border-0 pb-0 flex-wrap">
                        <div class="pr-3 me-auto mb-sm-0 mb-3">
                            <h4 class="fs-20 text-black mb-1">List Setting</h4>
                        ...
                        <div class="alert alert-primary">
                            <div class="row g-1 mt-3">
                                <div class="col-lg-6 col-sm-12">
                                    ...
                                    <span>Gunakan fitur ini untuk mengelola setting dengan efisien. Anda dapat
                                        melakukan
                                        hal-hal berikut:</span>
                                    <ul>
                                        <li>Menambahkan setting baru dengan mengisi formulir yang disediakan.</li>
                                        <li>Mengedit setting yang sudah ada untuk memperbarui informasi.</li>
                                        <li>Mengaktifkan atau menonaktifkan status setting sesuai kebutuhan.</li>
                                    </ul>
                                </div>
                                <div class="col-lg-6 col-sm-12">
                                    <strong>Ekstra:</strong> <br />
                                    <span>Hanya satu setting yang dapat aktif pada satu waktu.</span> <br />
    ...
    @include('ppdb.setting.views.create')
    @include('ppdb.setting.views.edit')
@endsection
...
@section('this-page-scripts')
    ...
    @include('ppdb.setting.scripts.store')
    @include('ppdb.setting.scripts.list')
    @include('ppdb.setting.scripts.show')
    @include('ppdb.setting.scripts.update')
@endsection
