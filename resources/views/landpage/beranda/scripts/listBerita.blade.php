        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                $.each(response.data, function(i, berita) {
                    var urlDetail = '{{ route('landpage.berita.detail', ':id') }}'.replace(':id',
                        berita.id_berita);
                    var image = berita.gambar ?? '{{ asset('template-landpage/img/default.jpg') }}';
            ...
            error: function(xhr) {
                ...
                $('#berita-list').html('<p>Gagal memuat data.</p>');
            }
        });
    }
