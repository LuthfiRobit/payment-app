...
@section('content')
    <div class="content-body default-height">
        <div class="container-fluid">
            <div class="form-head mb-4">
                <h2 class="text-black font-w600 mb-0">Master - CMS Kontak</h2>
            </div>
            <!-- coba -->
            <div class="row">
                <div class="card">
                    <div class="card-header d-sm-flex d-block border-0 pb-0 flex-wrap">
                        <div class="pr-3 me-auto mb-sm-0 mb-3">
                            <h4 class="fs-20 text-black mb-1">List Kontak</h4>
                        ...
                        <div class="alert alert-primary">
                            <div class="row g-1 mt-3">
                                <div class="col-lg-6 col-sm-12">
                                    ...
                                    <span>Gunakan fitur ini untuk mengelola kontak dengan efisien. Anda dapat
                                        melakukan
                                        hal-hal berikut:</span>
                                    <ul>
                                        <li>Menambahkan kontak baru dengan mengisi formulir yang disediakan.</li>
                                        <li>Mengedit kontak yang sudah ada untuk memperbarui informasi.</li>
                                        <li>Mengaktifkan atau menonaktifkan status kontak sesuai kebutuhan.</li>
                                    </ul>
                                </div>
                                <div class="col-lg-6 col-sm-12">
                                    <strong>Ekstra:</strong> <br />
                                    <span>Hanya satu kontak yang dapat aktif pada satu waktu.</span> <br />
    ...
    @include('master.kontak.views.create')
    @include('master.kontak.views.import')
    @include('master.kontak.views.edit')
@endsection
...
@section('this-page-scripts')
    ...
    @include('master.kontak.scripts.store')
    @include('master.kontak.scripts.list')
    @include('master.kontak.scripts.show')
    @include('master.kontak.scripts.update')
@endsection
