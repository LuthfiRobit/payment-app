...
@section('content')
    <div class="content-body default-height">
        <div class="container-fluid">
            <div class="form-head mb-4">
                <h2 class="text-black font-w600 mb-0">Master - Artikel</h2>
            </div>
                ...
                <div class="card">
                    <div class="card-header d-sm-flex d-block border-0 pb-0 flex-wrap">
                        <div class="pr-3 me-auto mb-sm-0 mb-3">
                            <h4 class="fs-20 text-black mb-1">List Artikel</h4>
                    ...
                    <div class="card-body">
                        <div class="alert alert-primary">
                            ...
                            <span>Gunakan fitur ini untuk mengelola artikel dengan efisien. Anda dapat melakukan hal-hal
                                berikut:</span>
                            <ul>
                                <li>Menambah artikel baru melalui formulir yang tersedia.</li>
                                <li>Mengedit artikel yang telah dipublikasikan.</li>
                                <li>Mengatur status artikel aktif (ditampilkan) atau tidak aktif (tidak ditampilkan) sesuai
                                    kebutuhan.</li>
                            </ul>
                        </div>
    ...
    @include('master.artikel.views.create')
    @include('master.artikel.views.edit')
@endsection
...
@section('this-page-scripts')
    ...
    @include('master.artikel.scripts.list')
    @include('master.artikel.scripts.store')
    @include('master.artikel.scripts.show')
    @include('master.artikel.scripts.update')
@endsection
