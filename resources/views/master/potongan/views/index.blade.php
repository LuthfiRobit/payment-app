...
@section('content')
    <div class="content-body default-height">
        <div class="container-fluid">
            <div class="form-head mb-4">
                <h2 class="text-black font-w600 mb-0">Master - Potongan</h2>
            </div>
            <!-- coba -->
            <div class="row">
                <div class="card">
                    <div class="card-header d-sm-flex d-block border-0 pb-0 flex-wrap">
                        <div class="pr-3 me-auto mb-sm-0 mb-3">
                            <h4 class="fs-20 text-black mb-1">List Potongan</h4>
                    ...
                    <div class="card-body">
                        <div class="alert alert-primary">
                            ...
                            <span>Gunakan fitur ini untuk mengelola potongan dengan efisien. Anda dapat melakukan hal-hal
                                berikut:</span>
                            <ul>
                                <li>Menambah potongan baru dengan mengisi formulir yang disediakan.</li>
                                <li>Mengedit potongan yang sudah ada untuk memperbarui informasi.</li>
                                <li>Mengaktifkan atau menonaktifkan status potongan sesuai kebutuhan.</li>
                            </ul>
                        </div>
    ...
    @include('master.potongan.views.create')
    @include('master.potongan.views.import')
    @include('master.potongan.views.edit')
@endsection
...
@section('this-page-scripts')
    ...
    @include('master.potongan.scripts.store')
    @include('master.potongan.scripts.list')
    @include('master.potongan.scripts.show')
    @include('master.potongan.scripts.update')
@endsection
