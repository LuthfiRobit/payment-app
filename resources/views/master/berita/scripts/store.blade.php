<script>
    ...
    $(document).ready(function() {
        ...
        handleFormBerita(
            '#createForm',
            '{{ route('master-data.berita.store') }}',
            'POST',
    ...
    function storeData(form) {
        ...
        const isiBerita = editor ? editor.getData() : '';
        if (isiBerita.trim() === '') {
            $('#modalError').removeClass('d-none').text('Isi berita tidak boleh kosong.');
            throw new Error('Isi berita kosong');
        }
    ...
    function handleFormBerita(formSelector, url, method, successMessage, getDataFn, isMultipart = false) {
